...
@section('content')
    ...
    <section class="gradient-hero relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-28">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="mt-6 text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed whitespace-pre-line">
    ...
    <section class="py-24 lg:py-32 bg-white dark:bg-slate-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
                {{-- Vision --}}
                <div class="card-hover bg-gradient-to-br from-slate-50 to-indigo-50/50 dark:from-slate-800 dark:to-indigo-950/30 rounded-3xl p-10 border border-slate-100 dark:border-slate-700">

                    <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4">{{ $settings['about_vision_title'] ?? 'Our Vision' }}</h3>
                ...
                {{-- Mission --}}
                <div class="card-hover bg-gradient-to-br from-slate-50 to-violet-50/50 dark:from-slate-800 dark:to-violet-950/30 rounded-3xl p-10 border border-slate-100 dark:border-slate-700">

                    <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-6">{{ $settings['about_mission_title'] ?? 'Our Mission' }}</h3>
                    <ul class="space-y-4 text-slate-600 dark:text-slate-300 text-lg">
                        @if(!empty($settings['about_mission_text_1']))
                        <li class="flex items-start gap-3">
                            <div class="mt-1 w-6 h-6 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center flex-shrink-0"><svg class="w-4 h-4 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg></div>
    ...
    <section class="py-24 lg:py-32 bg-slate-50 dark:bg-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="card-hover group text-center p-6 rounded-3xl transition-all duration-300 hover:bg-white dark:hover:bg-slate-800 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-black/30 border border-transparent hover:border-slate-100 dark:hover:border-slate-600">
                    <div class="relative mb-6 mx-auto w-40 h-40 rounded-3xl overflow-hidden shadow-lg">
                        ...
                        @else
                            <div class="w-full h-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-indigo-500 text-4xl font-bold transition-transform duration-500 group-hover:scale-110">
                ...
                @empty
                    <div class="col-span-full text-center text-slate-500 dark:text-slate-400 py-10">
