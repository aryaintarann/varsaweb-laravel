...
<body class="min-h-screen bg-[#B7C0C6] text-slate-800 font-sans antialiased">
    <header class="sticky top-0 z-50 w-full pt-4">
        <div class="max-w-6xl mx-auto px-6">
            <div class="relative rounded-2xl border border-white/50 bg-white/40 backdrop-blur-xl px-5 md:px-6 py-3 flex items-center justify-between gap-4 shadow-xl shadow-slate-200/40 transition-all duration-300 hover:bg-white/50 hover:border-white/80">
                <nav class="hidden md:flex items-center gap-4 md:gap-6 text-sm text-slate-700">
                    ...
                    <a href="{{ route('contact') }}" class="relative pb-1 text-brand-600 font-semibold after:absolute after:left-0 after:-bottom-0.5 after:h-0.5 after:w-full after:bg-brand-500">Contact</a>
                </nav>
                ...
                <details class="md:hidden group ml-auto">
                    ...
                    <div class="absolute left-0 right-0 top-full mt-2 rounded-2xl border border-white/60 bg-white/80 backdrop-blur-xl p-3 shadow-xl shadow-slate-200/40 z-40 origin-top opacity-0 -translate-y-1 scale-95 pointer-events-none transition-all duration-300 ease-out group-open:opacity-100 group-open:translate-y-0 group-open:scale-100 group-open:pointer-events-auto">
                        <nav class="flex flex-col gap-1 text-sm text-slate-700">
                            ...
                            <a href="{{ route('services') }}" class="rounded-lg px-3 py-2 hover:bg-white/70 transition-colors">Services</a>
                            <a href="{{ route('contact') }}" class="rounded-lg px-3 py-2 bg-white/70 text-brand-600 font-semibold">Contact</a>
    ...
    <main class="max-w-6xl mx-auto px-6 py-16">
        <section class="rounded-3xl border border-white/50 bg-white/40 backdrop-blur-xl p-6 md:p-10 shadow-xl shadow-slate-200/40 transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/50 hover:border-white/80 hover:shadow-2xl hover:shadow-slate-200/55">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <article class="rounded-2xl border border-white/60 bg-white/40 backdrop-blur-md p-5 transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/55 hover:border-white/80 hover:shadow-lg hover:shadow-slate-200/55">
        ...
        <section class="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            <article class="lg:col-span-2 rounded-3xl border border-white/50 bg-white/40 backdrop-blur-xl p-6 md:p-8 shadow-xl shadow-slate-200/40 transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/50 hover:border-white/80 hover:shadow-2xl hover:shadow-slate-200/55">
            ...
            <aside class="rounded-3xl border border-white/50 bg-white/40 backdrop-blur-xl p-6 shadow-xl shadow-slate-200/40 transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/50 hover:border-white/80 hover:shadow-2xl hover:shadow-slate-200/55">
                ...
                <div class="mt-5 grid grid-cols-3 gap-3">
                    <a href="#" aria-label="Instagram" class="h-12 rounded-xl bg-white/45 backdrop-blur-md text-slate-700 border border-white/70 flex items-center justify-center hover:bg-brand-500 hover:text-white hover:border-brand-500 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:shadow-slate-200/55">
                    ...
                    <a href="#" aria-label="LinkedIn" class="h-12 rounded-xl bg-white/45 backdrop-blur-md text-slate-700 border border-white/70 flex items-center justify-center hover:bg-brand-500 hover:text-white hover:border-brand-500 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:shadow-slate-200/55">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    <a href="#" aria-label="X / Twitter" class="h-12 rounded-xl bg-white/45 backdrop-blur-md text-slate-700 border border-white/70 flex items-center justify-center hover:bg-brand-500 hover:text-white hover:border-brand-500 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:shadow-slate-200/55">
                ...
                <div class="mt-6 rounded-2xl bg-white/40 backdrop-blur-md border border-white/70 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/55 hover:border-white hover:shadow-lg hover:shadow-slate-200/55">
    ...
    <footer class="mt-14 pb-10">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="rounded-2xl border border-white/50 bg-white/40 backdrop-blur-xl p-10 shadow-xl shadow-slate-200/40 transition-all duration-300 hover:bg-white/50 hover:border-white/80">
