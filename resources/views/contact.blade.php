...
<body class="min-h-screen bg-slate-50 text-slate-800 font-sans antialiased">
    ...
    <main class="max-w-5xl mx-auto px-6 py-16">
        <h1 class="font-display text-4xl md:text-5xl font-bold text-slate-900 text-center">Get in Touch</h1>
        <p class="mt-6 text-lg text-slate-600 leading-relaxed max-w-3xl mx-auto text-center">
            Ceritakan kebutuhan website Anda, dan tim kami akan membantu menyiapkan solusi terbaik.
        </p>

        <section class="mt-10">
            <article class="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <div class="mt-4 flex items-center gap-3">
                            <a href="#" aria-label="Instagram" class="w-10 h-10 rounded-full bg-slate-100 text-slate-600 border border-slate-200 flex items-center justify-center hover:bg-brand-500 hover:text-white hover:border-brand-500 transition-colors">
                            ...
                            <a href="#" aria-label="LinkedIn" class="w-10 h-10 rounded-full bg-slate-100 text-slate-600 border border-slate-200 flex items-center justify-center hover:bg-brand-500 hover:text-white hover:border-brand-500 transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                            </a>
                            <a href="#" aria-label="X / Twitter" class="w-10 h-10 rounded-full bg-slate-100 text-slate-600 border border-slate-200 flex items-center justify-center hover:bg-brand-500 hover:text-white hover:border-brand-500 transition-colors">
